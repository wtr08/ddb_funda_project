...
funda_gemeente_facilties.head()

funda_gemeente_facilties = funda_gemeente_facilties.drop(['Buurt2018', 'Gemcode'], axis=1)
funda_buurt_facilties = funda_buurt_facilties.drop(['Gemeente2018', 'Buurtcode', 'Wijken_en_buurten', 'Soort_regio', 'codering', 'Afstand_tot_huisartsenpraktijk_km', 'Afstand_tot_grote_supermarkt_km', 'Afstand_tot_kinderdagverblijf_km', 'Afstand_tot_school_km' ], axis=1)
